...
<template>
  <section
    class="py-16 bg-blend-hard-light bg-center bg-cover bg-no-repeat bg-[url('../assets/images/background_image_plane.png')]"
    id="contact"
  >
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <h1 class="text-center text-4xl lg:text-5xl xl:text-6xl mb-8 lg:mb-16 font-bold">Get In Touch</h1>
      <div class="flex justify-center items-center">
        <div class="flex flex-col xl:flex-row gap-5 md:gap-10 lg:gap-16 xl:gap-20">
          <div class="basis-1/2 space-y-8">
            ...
            <!-- <div class="flex flex-col">
              <div class="inline-flex items-center space-x-3">
                ...
                <span class="md:text-lg select-all font-medium">
              ...
              <div class="inline-flex items-center space-x-2">
                ...
                <span class="md:text-lg select-all font-medium"> +639510505308 </span>
              </div>
            </div>
            <div>
              <h4
              ...
              <div class="flex space-x-5">
                <a
                  ...
                  target="_blank"
                  class="transition duration-150 ease-in-out hover:scale-110 hover:text-accent"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=639510505308"
                  target="_blank"
                  class="transition duration-150 ease-in-out hover:scale-110 hover:text-accent"
                >
                  <svg
                ...
                <a
                  href="https://join.skype.com/invite/uLpxKBOeGhAt"
                  target="_blank"
                  class="transition duration-150 ease-in-out hover:scale-110 hover:text-accent"
                >
                  <svg
                ...
                <a
                  href="https://www.linkedin.com/in/jake-dave-de-guzman-6178a92bb/"
                  target="_blank"
                  class="transition duration-150 ease-in-out hover:scale-110 hover:text-accent"
                >
                  <svg
          ...
          <div
            class="basis-1/2 space-y-3 p-3 md:p-5 lg:p-8 border border-gray-200 shadow-2xl bg-gray-200 z-10"
          >
            <form @submit.prevent="sendEmail">
              ...
              <!-- <button
            class="text-white bg-primary hover:bg-hover transition duration-150 ease-in-out transform hover:scale-105 rounded-lg">
            <div class="py-2.5 px-4">
                <span class="font-medium">Send</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="size-6 inline ms-2 mb-0.5">
              ...
              <button
                class="cursor-pointer w-full md:w-1/4 mt-4 text-white bg-blue-500 hover:bg-blue-700 transition duration-150 ease-in-out transform hover:scale-105 rounded-lg"
              >
                <div class="py-2.5 px-4">
                  <span class="font-medium">Send</span>
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="size-6 inline ms-2 mb-0.5"
                  >
                    <path
